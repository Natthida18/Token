	...
	if ( function_exists( 'acf_add_local_field_group' ) ) {
		...
		acf_add_local_field_group(
			array(
				...
				'fields'   => array(
					array(
						'key'     => 'field_machine_page_title_th',
						'label'   => 'Page Title TH',
						'name'    => 'machine_page_title_th',
						'type'    => 'text',
						'wrapper' => array(
							'width' => '50%',
						),
					...
					array(
						'key'     => 'field_machine_page_title_en',
						'label'   => 'Page Title EN',
						'name'    => 'machine_page_title_en',
						'type'    => 'text',
						'wrapper' => array(
							'width' => '50%',
						),
					...
					array(
						'key'   => 'field_tab_mahcine_section1',
						'label' => 'Section 1',
						'name'  => 'tab_machine_section1',
						'type'  => 'tab',
					),
					array(
					...
					array(
						'key'           => 'field_machine_section1_image2',
						'label'         => 'Image 2',
						'name'          => 'machine_section1_image2',
						'type'          => 'image',
						'return_format' => 'id',
						'wrapper'       => array(
							'width' => '50%',
					...
					array(
						'key'           => 'field_machine_section1_image4',
						'label'         => 'Image 4',
						'name'          => 'machine_section1_image4',
						'type'          => 'image',
						'return_format' => 'id',
						'wrapper'       => array(
							'width' => '25%',
					...
					array(
						'key'           => 'field_machine_section1_image5',
						'label'         => 'Image 5',
						'name'          => 'machine_section1_image5',
						'type'          => 'image',
						'return_format' => 'id',
						'wrapper'       => array(
							'width' => '25%',
					...
					array(
						'key'           => 'field_machine_section1_image6',
						'label'         => 'Image 6',
						'name'          => 'machine_section1_image6',
						'type'          => 'image',
						'return_format' => 'id',
						'wrapper'       => array(
							'width' => '25%',
					...
					array(
						'key'   => 'field_tab_mahcine_section2',
						'label' => 'Section 2',
						'name'  => 'tab_machine_section2',
						'type'  => 'tab',
					),
					array(
					...
					array(
						...
						'label' => 'Content 1',
						'name'  => 'machine_section2_content1',
						'type'  => 'wysiwyg',
					),
					array(
						'key'        => 'field_repeater_compare_table',
						'label'      => 'Compare Table',
						'name'       => 'repeater_compare_table',
						'type'       => 'repeater',
						'sub_fields' => array(
							array(
								'key'   => 'field_repeater_compare_table_title',
								'label' => 'Title',
								'name'  => 'compare_table_title',
								'type'  => 'text',
							),
							array(
								'key'        => 'field_repeater_compare_table_value_list',
								'label'      => 'Value List',
								'name'       => 'compare_table_value_list',
								'type'       => 'repeater',
								'sub_fields' => array(
									array(
										'key'   => 'field_repeater_compare_table_value',
										'label' => 'Value',
										'name'  => 'compare_table_value',
										'type'  => 'text',
									),
								),
							),
					...
					array(
						'key'   => 'field_machine_section2_content3',
						'label' => 'Content 3',
						'name'  => 'machine_section2_content3',
						'type'  => 'text',
					),
					array(
						'key'   => 'field_machine_section2_content4',
						'label' => 'Content 4',
						'name'  => 'machine_section2_content4',
						'type'  => 'text',
					),
					array(
						'key'           => 'field_machine_section2_image1',
						'label'         => 'Image 1',
						'name'          => 'machine_section2_image1',
						'type'          => 'image',
						'return_format' => 'id',
						'wrapper'       => array(
							'width' => '50%',
					...
					array(
						'key'           => 'field_machine_section2_image2',
						'label'         => 'Image 2',
						'name'          => 'machine_section2_image2',
						'type'          => 'image',
						'return_format' => 'id',
						'wrapper'       => array(
							'width' => '50%',
					...
					array(
						'key'        => 'field_repeater_stretch_detail',
						'label'      => 'Stretch Detail',
						'name'       => 'repeater_stretch_detail',
						'type'       => 'repeater',
						'sub_fields' => array(
							array(
								'key'   => 'field_repeater_stretch_detail_title',
								'label' => 'Title',
								'name'  => 'stretch_detail_title',
								'type'  => 'text',
							),
							array(
								'key'        => 'field_repeater_stretch_detail_value_list',
								'label'      => 'Value List',
								'name'       => 'stretch_detail_value_list',
								'type'       => 'repeater',
								'sub_fields' => array(
									array(
										'key'   => 'field_repeater_stretch_detail_value',
										'label' => 'Value',
										'name'  => 'stretch_detail_value',
										'type'  => 'text',
									),
								),
							),
					...
					array(
						'key'   => 'field_machine_section2_shortcode',
						'label' => 'Shortcode',
						'name'  => 'shortcode_section2',
						'type'  => 'text',
					),
					array(
						'key'           => 'field_machine_section2_image3',
						'label'         => 'Image 3',
						'name'          => 'machine_section2_image3',
						'type'          => 'image',
						'return_format' => 'id',
					),
					array(
						'key'   => 'field_machine_section2_content5',
						'label' => 'Content 5',
						'name'  => 'machine_section2_content5',
						'type'  => 'wysiwyg',
					),
					array(
						'key'   => 'field_machine_section2_tips_title',
						'label' => 'Tips Title',
						'name'  => 'tips_title',
						'type'  => 'text',
					),
					array(
						'key'   => 'field_machine_section2_tips_link',
						'label' => 'Tips Link',
						'name'  => 'tips_link',
						'type'  => 'url',
					),
					array(
						'key'   => 'field_machine_section2_dictionary',
						'label' => 'Dictionary',
						'name'  => 'machine_section2_dictionary',
						'type'  => 'text',
					),
					array(
						'key'        => 'field_repeater_dictionary',
						'label'      => 'Words',
						'name'       => 'repeater_dictionary',
						'type'       => 'repeater',
						'sub_fields' => array(
							array(
								'key'   => 'field_repeater_dictionary_link',
								'label' => 'Link',
								'name'  => 'repeater_dictionary_link',
								'type'  => 'url',
							),
							array(
								'key'   => 'field_repeater_dictionary_word',
								'label' => 'Word',
								'name'  => 'repeater_dictionary_word',
								'type'  => 'text',
							),
						),
					),
					array(
						'key'           => 'field_machine_section2_recentwork_image',
						'label'         => 'Recent Work Image',
						'name'          => 'machine_section2_recentwork_image',
						'type'          => 'image',
						'return_format' => 'id',
					),
					array(
						'key'   => 'field_machine_section2_recentwork_link',
						'label' => 'Recent Work Link',
						'name'  => 'machine_section2_recentwork_link',
						'type'  => 'url',
					),
					array(
						'key'   => 'field_tab_mahcine_section3',
						'label' => 'Section 3',
						'name'  => 'tab_machine_section3',
						'type'  => 'tab',
					),
					array(
						'key'   => 'field_machine_section3_headline',
						'label' => 'Headline',
						'name'  => 'machine_section3_headline',
						'type'  => 'text',
					),
					array(
					...
					array(
						...
						'label'   => 'Content 1',
						'name'    => 'machine_section3_content1',
						'type'    => 'wysiwyg',
						'wrapper' => array(
							'width' => '50%',
						),
					...
					array(
						'key'     => 'field_machine_section3_content2',
						'label'   => 'Content 2',
						'name'    => 'machine_section3_content2',
						'type'    => 'wysiwyg',
						'wrapper' => array(
							'width' => '50%',
						),
					...
					array(
						'key'   => 'field_machine_section3_tips_title',
						'label' => 'Tips Title',
						'name'  => 'machine_section3_tips_title',
						'type'  => 'text',
					),
					array(
						'key'   => 'field_machine_section3_tips_link',
						'label' => 'Tips Link',
						'name'  => 'machine_section3_tips_link',
						'type'  => 'url',
					),
					array(
						'key'           => 'field_machine_section3_image1',
						'label'         => 'Image 1',
						'name'          => 'machine_section3_image1',
						'type'          => 'image',
						'return_format' => 'id',
						'wrapper'       => array(
							'width' => '33%',
					...
					array(
						'key'           => 'field_machine_section3_image2',
						'label'         => 'Image 2',
						'name'          => 'machine_section3_image2',
						'type'          => 'image',
						'return_format' => 'id',
						'wrapper'       => array(
							'width' => '33%',
					...
					array(
						'key'           => 'field_machine_section3_image3',
						'label'         => 'Image 3',
						'name'          => 'machine_section3_image3',
						'type'          => 'image',
						'return_format' => 'id',
						'wrapper'       => array(
							'width' => '33%',
					...
					array(
						'key'   => 'field_tab_mahcine_section4',
						'label' => 'Section 4',
						'name'  => 'tab_machine_section4',
						'type'  => 'tab',
					),
					array(
						'key'   => 'field_machine_section4_headline',
						'label' => 'Headline',
						'name'  => 'machine_section4_headline',
						'type'  => 'text',
					),
					array(
						'key'        => 'field_repeater_machine_usage_detail',
						'label'      => 'Usage Detail',
						'name'       => 'repeater_machine_usage_detail',
						'type'       => 'repeater',
						'sub_fields' => array(
							array(
								'key'           => 'field_repeater_machine_usage_detail_image',
								'label'         => 'Image',
								'name'          => 'machine_usage_detail_image',
								'type'          => 'image',
								'return_format' => 'id',
							),
							array(
								'key'   => 'field_repeater_machine_usage_detail_title',
								'label' => 'Title',
								'name'  => 'machine_usage_detail_title',
								'type'  => 'text',
							),
							array(
								'key'   => 'field_repeater_machine_usage_detail_content',
								'label' => 'Content',
								'name'  => 'machine_usage_detail_content',
								'type'  => 'textarea',
							),
						),
					),
					array(
						'key'   => 'field_tab_mahcine_section5',
						'label' => 'Section 5',
						'name'  => 'tab_machine_section5',
						'type'  => 'tab',
					),
					array(
						'key'   => 'field_machine_section5_headline',
						'label' => 'Headline',
						'name'  => 'machine_section5_headline',
						'type'  => 'text',
					),
					array(
						'key'   => 'field_machine_section5_content',
						'label' => 'Content',
						'name'  => 'machine_section5_content',
						'type'  => 'wysiwyg',
					),
					array(
						'key'   => 'field_tab_mahcine_section6',
						'label' => 'Section 6',
						'name'  => 'tab_machine_section6',
						'type'  => 'tab',
					),
					array(
						'key'   => 'field_machine_section6_headline',
						'label' => 'Headline',
						'name'  => 'machine_section6_headline',
						'type'  => 'text',
					),
					array(
						'key'   => 'field_machine_section6_video',
						'label' => 'Video',
						'name'  => 'machine_section6_video',
						'type'  => 'oembed',
					),
					array(
						'key'   => 'field_machine_section6_video_desc',
						'label' => 'Description',
						'name'  => 'machine_section6_video_desc',
						'type'  => 'wysiwyg',
					),
				),
				'location' => array(
